...
export default class ProjurisFaturamentoDataStructure {
  constructor(
    ...
    conta,
    descricao,
    unidadeOrganizacional = hardcoded.unidadeOrganizacional,
    favorecido = hardcoded.favorecido,
    planoConta = hardcoded.planoConta,
    tipoResponsavelPagamento = hardcoded.tipoResponsavelPagamento,
    tipoLancamentoFinanceiro = hardcoded.tipoLancamentoFinanceiro,
    tipoDocumento = hardcoded.tiposDocumento.notaFiscal,
    condicaoPagamento = hardcoded.condicoesPagamento.aVista,
    numeroTotalParcelas = hardcoded.numeroParcelas,
    formaPagamento = hardcoded.formaPagamento,
