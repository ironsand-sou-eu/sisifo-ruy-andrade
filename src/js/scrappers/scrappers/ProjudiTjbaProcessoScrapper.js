...
class ProjudiTjbaProcessoScrapper {
  ...
  static #PROJUDI_EXTENDED_DATE_REGEX =
  ...
  static async #ScrappeProcessoInfo() {
    ...
    const processoInfo = new ProcessoDataStructure(
      ...
      this.#getPartesRequerentes(),
      this.#getPartesRequeridas(),
  ...
  static #getValorDaCausa() {
    ...
    let valorDaCausa = projudiValorDaCausaString
      .trim()
      .replace(/(R\$ )|(\.)/g, "");
  ...
  static #getNumeroProcessoPrincipal() {
    ...
    const processoPrincipal =
      this.#getValueFollowingCellSearchedByTextContent(params);
    return processoPrincipal.toLowerCase().includes("o próprio")
      ? null
      : processoPrincipal;
  }
