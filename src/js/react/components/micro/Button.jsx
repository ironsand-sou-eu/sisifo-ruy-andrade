  ...
  return (
    <>
      <div className="capped-btn-container" {...{ open }}>
        ...
        <div
          className="btn-cap-group"
          onClick={() =>
            document
              .querySelector(".capped-btn-container")
              .setAttribute("open", "")
          }
        >
          <svg className="btn-cap" viewBox="0 0 100 55">
            ...
            <path
              d="m -5 0 l 100 0 a 10 10 0 0 1 10 10 l 0 35 a 10 10 0 0 1 -10 10 l -100 0"
              fill="url(#grad)"
            />
            <path
              d="m -5 0 l 100 0 a 10 10 0 0 1 10 10 l 0 35 a 10 10 0 0 1 -10 10 l -100 0"
              fill="url(#box-texture)"
            />
            <path
              d="m -5 0 l 100 0 a 10 10 0 0 1 10 10 l 0 35 a 10 10 0 0 1 -10 10 l -100 0"
      ...
      <div className="form-group">
        <Messenger processingMsgs={warningMessages} scrollable={false} />
      </div>
    </>
  );
}
