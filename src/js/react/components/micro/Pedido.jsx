...
export default function Pedido({ pedido, index, onChange }) {
  ...
  const filterFunction = (input) =>
    loadSimpleOptions(endPoints.pedidos + input, {
      key: "valor",
  ...
  function getPrognosticoOption(prognosticoValue) {
    return prognosticoOptions.find(
      (prognosticoOption) => prognosticoOption.value === prognosticoValue,
    );
  }
